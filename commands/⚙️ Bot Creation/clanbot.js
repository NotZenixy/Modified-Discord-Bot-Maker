...
module.exports = {
    ...
    run: async (client, message, args, user, text, prefix) => {
     ...
     let guild = client.guilds.cache.get("944487115985682492");
     let checkUser = guild.members.cache.get(user.id);
     let checkRole = checkUser.roles.cache.get(config._roles);
    if(!checkRole) {
        return message.channel.send(new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle(`Only Bot Creators Can Execute This Command!`)
      )
                                    }
    ...
    try{
      ...
      client.stats.inc(message.guild.id, "clanbot")
      client.stats.inc("global", "clanbot")
              ...
              author.send(new MessageEmbed()
                ...
                author.send(
                  ...
                  .then(collected => {
                    ...
                    let clanbotconfig = require("../../bots/discordjshandler/botconfig/config.json")
                    let oldconfig = clanbotconfig;
